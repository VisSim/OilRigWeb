...
window.addEventListener('load', e => {
    ...
    createApp({
        ...
        sceneURL: params.load || '__URL__OilPlatform.glb'.replace('__URL__', ''),
...
function runCode(app, puzzles) {
    ...
    app.scene.background = new v3d.TextureLoader().load("images/ClearSky.png");

    // Debugging: Frame Rate & Performance profiling 
    //app.showFPS();
    //app.printPerformanceInfo();

    // Camera Orbital controls - Damping & Inertia
    // app.controls.enableDamping = true;
    // app.controls.dampingFactor = 0.1;
    // app.controls.rotateInertia = 0.1;
    // app.controls.rotateInertiaTouch = 0.1;
    // app.controls.panInertia = 0.1;
    // app.controls.panInertiaTouch = 0.1;
    // app.controls.zoomInertia = 0.1;
    // app.controls.zoomInertiaTouch = 0.1;
...
function createAnnotations(app){
    let annotate01 = ('<b>Helideck</b><br><br> ' + '\n' +
    'For more details, check' + '\n' +
    '<a href="https://en.wikipedia.org/wiki/Oil_platform" style="color: yellow" target = "_blank">Oil Platform</a>' + '\n' +
    '');
  
    let annotate02 = ('<b>Crane</b><br><br> ' + '\n' +
    'For more details, check' + '\n' +
    '<a href="https://en.wikipedia.org/wiki/Oil_platform" style="color: yellow" target = "_blank">Oil Platform</a>' + '\n' +
    '');  

    let annotate03 = ('<b>Crown Block</b><br><br> ' + '\n' +
    'For more details, check' + '\n' +
    '<a href="https://en.wikipedia.org/wiki/Oil_platform" style="color: yellow" target = "_blank">Oil Platform</a>' + '\n' +
    '');

    let annotate04 = ('<b>Electric Control House</b><br><br> ' + '\n' +
    'For more details, check' + '\n' +
    '<a href="https://en.wikipedia.org/wiki/Oil_platform" style="color: yellow" target = "_blank">Oil Platform</a>' + '\n' +
    '');

    let annotate05 = ('<b>Life Boat</b><br><br> ' + '\n' +
    'For more details, check' + '\n' +
    '<a href="https://en.wikipedia.org/wiki/Oil_platform" style="color: yellow" target = "_blank">Oil Platform</a>' + '\n' +
    '');

    let annotate06 = ('<b>Travelling Block</b><br><br> ' + '\n' +
    'For more details, check' + '\n' +
    '<a href="https://en.wikipedia.org/wiki/Oil_platform" style="color: yellow" target = "_blank">Oil Platform</a>' + '\n' +
    '');
      
    // Add annotations to the scene
    handleAnnot(app, true, '1', 'HeliPad_Annotation', annotate01, 'an_1', undefined);
    handleAnnot(app, true, '2', 'Crane_Annotation', annotate02, 'an_2', undefined);
    handleAnnot(app, true, '3', 'Crown_Annotation', annotate03, 'an_3', undefined);
    handleAnnot(app, true, '4', 'Electric_Annotation', annotate04, 'an_4', undefined);   
    handleAnnot(app, true, '5', 'Boat_Annotation', annotate05, 'an_5', undefined);   
    handleAnnot(app, true, '6', 'Travel_Annotation', annotate06, 'an_6', undefined);   

    // Hide annotations (by default)
    setHTMLElemStyle('display', 'none', ['an_1', 'an_2', 'an_3', 'an_4', 'an_5', 'an_6'], false);
  }
